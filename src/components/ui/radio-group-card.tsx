  ...
  return (
    ...
    >
      <Card className={cn(
        ...
        "group-disabled:cursor-not-allowed group-disabled:opacity-40 group-disabled:bg-gray-100 group-disabled:dark:bg-gray-800 group-disabled:hover:border-gray-200",
