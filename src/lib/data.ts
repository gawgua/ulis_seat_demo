...
const CANTEEN_SEAT_MAP = [
	...
	{ id: "3", status: "occupied" as const, x: 0, y: 6.25, width: 1.5, capacity: 5 },
	{ id: "4", status: "available" as const, x: 1.75, y: 3.5, width: 2, height:2, capacity: 8 },
	{ id: "5", status: "available" as const, x: 0, y: 4.75, width: 1.5, capacity: 5 },
	{ id: "6", status: "available" as const, x: 0, y: 2.75, width: 1.5, capacity: 5 },
	{ id: "7", status: "occupied" as const, x: 1.75, y: 2.25, width: 1.5, capacity: 5 },
	{ id: "8", status: "available" as const, x: 1.75, y: 0, width: 2, height:2, capacity: 8 },
	{ id: "9", status: "occupied" as const, x: 0, y: 1, width: 1.5, capacity: 5 },
	{ id: "10", status: "available" as const, x: 0, y: 0, width: 1.5, capacity: 5 },
	{ id: "18", status: "available" as const, x: 6.5, y: 0, height: 1.5, capacity: 5 },
	{ id: "15", status: "available" as const, x: 6.5, y: 2.25, height: 1.5, capacity: 5 },
	{ id: "14", status: "occupied" as const, x: 6.5, y: 4, height: 1.5, capacity: 5 },
	{ id: "11", status: "available" as const, x: 6.5, y: 6.25, height: 1.5, capacity: 5 },
