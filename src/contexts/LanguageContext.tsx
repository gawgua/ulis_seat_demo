...
const translations = {
	vi: {
		...
		"location.homies_multi": "Homies Đa năng",
		"location.homies_multi.desc": "Tầng 2 nhà Đa năng. Chủ yếu chỗ cá nhân, nhiều ổ cắm điện.",
		...
		"landing.features.groupPersonal.title": "Cá nhân & Nhóm",
		"landing.features.groupPersonal.desc": "Hỗ trợ cả làm việc cá nhân và học nhóm với bàn từ 1-8 người",
		"landing.locations.title": "Địa điểm có sẵn",
		"landing.video.title": "Cách dùng thế nào?",
		"landing.cta.title": "Sẵn sàng bắt đầu?",
		"landing.cta.desc": "Đăng nhập ngay để đặt chỗ ngồi yêu thích của bạn",
		"landing.cta.button": "Đăng nhập ngay",
	...
	en: {
		...
		"location.homies_multi": "Homies Multi-purpose",
		"location.homies_multi.desc": "2nd floor, Multi-purpose hall. Mainly personal seats, many power outlets.",
		...
		"landing.features.groupPersonal.title": "Personal & Group",
		"landing.features.groupPersonal.desc": "Support both individual work and group study with tables for 1-8 people",
		"landing.locations.title": "Available Locations",
		"landing.video.title": "See How It Works",
		"landing.cta.title": "Ready to Start?",
		"landing.cta.desc": "Login now to book your favorite seat",
		"landing.cta.button": "Login Now",
